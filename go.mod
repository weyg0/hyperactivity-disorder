module github.com/weyg0/hyperactivity-disorder
...
replace (
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.25.9
	k8s.io/sample-controller => k8s.io/sample-controller v0.25.9
)
